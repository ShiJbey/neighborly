...
from neighborly.core.query import Query, QueryFromFn, ne_, where, where_not
...
def friendship_gt(threshold: float) -> QueryFromFn:
...
def friendship_lt(threshold: float) -> QueryFromFn:
    """Returns a list of all the GameObjects with the given component"""
...
def has_component(component_type: Type[Component]) -> QueryFromFn:
    """Returns a list of all the GameObjects with the given component"""
...
def has_fur_color(fur_color: str) -> QueryFromFn:
