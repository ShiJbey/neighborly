...
def setup(sim: Neighborly):
    ...
    sim.add_location_bias_rule(
        virtue_to_activity_bias(Virtue.EXCITEMENT, "Gambling", 1)
    )
    ...
    sim.add_location_bias_rule(
        virtue_to_activity_bias(Virtue.EXCITEMENT, "Shopping", 1)
    )
    sim.add_location_bias_rule(
        virtue_to_activity_bias(Virtue.LEISURE_TIME, "Shopping", 1)
    )
    sim.add_location_bias_rule(virtue_to_activity_bias(Virtue.HEALTH, "Recreation", 1))
    sim.add_location_bias_rule(
        virtue_to_activity_bias(Virtue.EXCITEMENT, "Recreation", 1)
    )
    ...
    sim.add_location_bias_rule(
        virtue_to_activity_bias(Virtue.LEISURE_TIME, "Reading", 1)
    )
    sim.add_location_bias_rule(
        virtue_to_activity_bias(Virtue.RELIABILITY, "Errands", 1)
    )
    ...
    sim.add_location_bias_rule(
        virtue_to_activity_bias(Virtue.SOCIALIZING, "Socializing", 1)
    )
    sim.add_location_bias_rule(
        virtue_to_activity_bias(Virtue.EXCITEMENT, "Socializing", 1)
    )
    sim.add_location_bias_rule(
        virtue_to_activity_bias(Virtue.FRIENDSHIP, "Socializing", 1)
    )
    sim.add_location_bias_rule(
        virtue_to_activity_bias(Virtue.SOCIALIZING, "Drinking", 1)
    )
    sim.add_location_bias_rule(
        virtue_to_activity_bias(Virtue.FRIENDSHIP, "Drinking", 1)
    )
    sim.add_location_bias_rule(virtue_to_activity_bias(Virtue.HEALTH, "Relaxing", 1))
    sim.add_location_bias_rule(
        virtue_to_activity_bias(Virtue.TRANQUILITY, "Relaxing", 1)
    )
    sim.add_location_bias_rule(
        virtue_to_activity_bias(Virtue.LEISURE_TIME, "Relaxing", 1)
    )
