...
class FriendshipBoostFromVirtueCompatibility(SocialRule):
    ...
    def apply(self, owner: GameObject, target: GameObject, relationship: GameObject) -> None:
        ...
        compatibility = round(5 * float(owner_virtues.compatibility(target_virtues)) / 100.0)
...
class RomanceBoostFromAgeDifference(SocialRule):
    def apply(self, owner: GameObject, target: GameObject, relationship: GameObject) -> None:
        ...
        modifier_value = -1 * round(lerp(-3, 3, min(1.0, abs(owner_age - target_age) / 10)))
        relationship.get_component(Romance).add_modifier(
            RelationshipModifier.create(
                value=modifier_value,
                modifier_type=ModifierType.Flat,
...
class InRelationshipRomanceRule(SocialRule):
    def apply(self, owner: GameObject, target: GameObject, relationship: GameObject) -> None:
        relationship.get_component(Romance).add_modifier(
            RelationshipModifier.create(value=-2, modifier_type=ModifierType.Flat, source=self)
        )
...
def setup(sim: Neighborly):
    ...
    social_rule_library.add_rule(
        VirtueRule(Virtue.ADVENTURE, Virtue.TRANQUILITY, {Friendship: (-1, ModifierType.Flat)})
    )
    social_rule_library.add_rule(
        VirtueRule(Virtue.TRANQUILITY, Virtue.ADVENTURE, {Friendship: (-1, ModifierType.Flat)})
    )

    social_rule_library.add_rule(
        VirtueRule(Virtue.ADVENTURE, Virtue.TRADITION, {Friendship: (-1, ModifierType.Flat)})
    )
    social_rule_library.add_rule(
        VirtueRule(Virtue.TRADITION, Virtue.ADVENTURE, {Friendship: (-1, ModifierType.Flat)})
    )

    social_rule_library.add_rule(
        VirtueRule(Virtue.EXCITEMENT, Virtue.TRANQUILITY, {Friendship: (-1, ModifierType.Flat)})
    )
    social_rule_library.add_rule(
        VirtueRule(Virtue.TRANQUILITY, Virtue.EXCITEMENT, {Friendship: (-1, ModifierType.Flat)})
    )

    social_rule_library.add_rule(
        VirtueRule(Virtue.ROMANCE, Virtue.LOYALTY, {Romance: (-1, ModifierType.Flat)})
    )
    social_rule_library.add_rule(
        VirtueRule(Virtue.LOYALTY, Virtue.ROMANCE, {Romance: (-1, ModifierType.Flat)})
    )

    social_rule_library.add_rule(
        VirtueRule(Virtue.PEACE, Virtue.POWER, {Friendship: (-1, ModifierType.Flat)})
    )
    social_rule_library.add_rule(
        VirtueRule(Virtue.POWER, Virtue.PEACE, {Friendship: (-1, ModifierType.Flat)})
    )

    social_rule_library.add_rule(
        VirtueRule(Virtue.EXCITEMENT, Virtue.PEACE, {Friendship: (-1, ModifierType.Flat)})
    )
    social_rule_library.add_rule(
        VirtueRule(Virtue.PEACE, Virtue.EXCITEMENT, {Friendship: (-1, ModifierType.Flat)})
    )

    social_rule_library.add_rule(
        VirtueRule(Virtue.WEALTH, Virtue.MATERIAL_THINGS, {Friendship: (1, ModifierType.Flat)})
    )
    social_rule_library.add_rule(
        VirtueRule(Virtue.MATERIAL_THINGS, Virtue.WEALTH, {Friendship: (1, ModifierType.Flat)})
    )

    social_rule_library.add_rule(
        VirtueRule(Virtue.KNOWLEDGE, Virtue.POWER, {Friendship: (1, ModifierType.Flat)})
    )
    social_rule_library.add_rule(
        VirtueRule(Virtue.POWER, Virtue.KNOWLEDGE, {Friendship: (1, ModifierType.Flat)})
    )

    social_rule_library.add_rule(
        VirtueRule(Virtue.WEALTH, Virtue.POWER, {Friendship: (1, ModifierType.Flat)})
    )
    social_rule_library.add_rule(
        VirtueRule(Virtue.POWER, Virtue.WEALTH, {Friendship: (1, ModifierType.Flat)})
    )

    social_rule_library.add_rule(
        VirtueRule(Virtue.ROMANCE, Virtue.LUST, {Romance: (1, ModifierType.Flat)})
    )
    social_rule_library.add_rule(
        VirtueRule(Virtue.LUST, Virtue.ROMANCE, {Romance: (1, ModifierType.Flat)})
    )

    # This is not reciprocal

    social_rule_library.add_rule(
        VirtueRule(Virtue.INDEPENDENCE, Virtue.FAMILY, {Friendship: (-1, ModifierType.Flat)})
    )

    social_rule_library.add_rule(
        VirtueRule(Virtue.CURIOSITY, Virtue.KNOWLEDGE, {Friendship: (1, ModifierType.Flat)})
    )
    social_rule_library.add_rule(
        VirtueRule(Virtue.KNOWLEDGE, Virtue.CURIOSITY, {Friendship: (1, ModifierType.Flat)})
    )

    social_rule_library.add_rule(
        VirtueRule(Virtue.PEACE, Virtue.NATURE, {Friendship: (1, ModifierType.Flat)})
    )

    social_rule_library.add_rule(
        VirtueRule(Virtue.NATURE, Virtue.MATERIAL_THINGS, {Friendship: (-1, ModifierType.Flat)})
    )

    social_rule_library.add_rule(
        VirtueRule(Virtue.AMBITION, Virtue.WEALTH, {Friendship: (1, ModifierType.Flat)})
    )
    social_rule_library.add_rule(
        VirtueRule(Virtue.AMBITION, Virtue.POWER, {Friendship: (1, ModifierType.Flat)})
    )

    social_rule_library.add_rule(
        VirtueRule(Virtue.INDEPENDENCE, Virtue.HEALTH, {Friendship: (1, ModifierType.Flat)})
    )

    social_rule_library.add_rule(
        VirtueRule(Virtue.LUST, Virtue.INDEPENDENCE, {Romance: (1, ModifierType.Flat)})
    )

    social_rule_library.add_rule(
        VirtueRule(Virtue.FRIENDSHIP, Virtue.FAMILY, {Romance: (1, ModifierType.Flat)})
    )
