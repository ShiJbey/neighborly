...
# from neighborly.core.life_event import EventLog, LifeEventRule
...
# class DeathEvent(LifeEventRule):
#     def __init__(self) -> None:
#         def p(gameobject: GameObject, **kwargs) -> bool:
...
# class BecameChildEvent(LifeEventRule):
#     def __init__(self) -> None:
#         def p(gameobject: GameObject, **kwargs) -> bool:
#             character = gameobject.get_component(GameCharacter)
...
# class BecameAdolescentEvent(LifeEventRule):
#     def __init__(self) -> None:
#         def p(gameobject: GameObject, **kwargs) -> bool:
#             character = gameobject.get_component(GameCharacter)
#             (
...
#             character = gameobject.get_component(GameCharacter)
#             world = gameobject.world
#             logger.debug(f"{str(character.name)} became and teen")
...
#         super().__init__("Became Teen", p, cb)


# class BecameYoungAdultEvent(LifeEventRule):
#     def __init__(self) -> None:
#         def p(gameobject: GameObject, **kwargs) -> bool:
#             character = gameobject.get_component(GameCharacter)
...
# class BecameAdultEvent(LifeEventRule):
#     def __init__(self) -> None:
#         def p(gameobject: GameObject, **kwargs) -> bool:
#             character = gameobject.get_component(GameCharacter)
...
# class BecameSeniorEvent(LifeEventRule):
#     def __init__(self) -> None:
#         def p(gameobject: GameObject, **kwargs) -> bool:
#             character = gameobject.get_component(GameCharacter)
...
# class UnemploymentEvent(LifeEventRule):
#     def __init__(self) -> None:
#         def p(gameobject: GameObject, **kwargs) -> bool:
#             """Die if they are older than a certain age and not immortal"""
...
# class BecameBusinessOwnerEvent(LifeEventRule):
#     def __init__(self) -> None:
#         def p(gameobject: GameObject, **kwargs) -> bool:
...
# class GetHiredEvent(LifeEventRule):
#     def __init__(self) -> None:
#         def p(gameobject: GameObject, **kwargs) -> bool:
#             """Characters get hired if they are unemployed"""
#             is_unemployed = gameobject.has_component(UnemployedStatus)
...
# class StartedDatingEvent(LifeEventRule):
#     def __init__(self) -> None:
#         def p(gameobject: GameObject, **kwargs) -> bool:
#             """Die if they are older than a certain age and not immortal"""
...
#             return any(
#                 [
#                     r.has_tags(RelationshipTag.LoveInterest)
#                     for r in single_love_interests
#                 ]
#             )
...
#                 filter(
#                     lambda rel: rel.has_tags(RelationshipTag.LoveInterest),
#                     [
...
# class DatingBreakUpEvent(LifeEventRule):
#     def __init__(self) -> None:
#         def p(gameobject: GameObject, **kwargs) -> bool:
...
# class MarriageEvent(LifeEventRule):
#     def __init__(self) -> None:
#         def p(gameobject: GameObject, **kwargs) -> bool:
#             """Die if they are older than a certain age and not immortal"""
...
# class FindTheirOwnPlace(LifeEventRule):
#     """
...
# class RetirementEvent(LifeEventRule):
#     """
